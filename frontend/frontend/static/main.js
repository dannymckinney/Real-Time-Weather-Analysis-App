...
var $author$project$Main$WeatherData = F5(
	function (temp, humidity, description, windSpeed, cityName) {
		return {cityName: cityName, description: description, humidity: humidity, temp: temp, windSpeed: windSpeed};
	});
...
var $author$project$Main$weatherDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$WeatherData,
	A2($elm$json$Json$Decode$field, 'temperature', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'humidity', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'description', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'windSpeed', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'cityName', $elm$json$Json$Decode$string));
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotWeather') {
			...
			return _Utils_Tuple2(model, $author$project$Main$getWeather);
		}
	});
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('temperature')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Temperature: ' + ($elm$core$String$fromFloat(weather.temp) + '°C'))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Description: ' + weather.description)
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('windSpeed')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Wind Speed: ' + ($elm$core$String$fromFloat(weather.windSpeed) + ' m/s'))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('cityName')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('City: ' + weather.cityName)
									]))
							]));
				} else {
					return A2(
